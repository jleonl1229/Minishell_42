...
**  write(1, "\033[2D\033[K", 6) -->ANSI escape codes. 
...
/*
**  initial karaket is opened with append permits to add lines
**	after every while loop iteration
...
/*
**  flow:
**  register and activate signals, close existing karaket files, 
**	iterate through intermediate hdoc delimiters until final one is reached. 
**	Then (in final_hdoc()) enter a loop that writes 
