...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/05 17:42:52 by mzuloaga          #+#    #+#             */
/*   Updated: 2024/09/05 17:46:41 by mzuloaga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	by default (at least in my laptop's version) Bash inits Shell with PWD
**	and without OLDPWD. if I unset PWD, unless I use "export" I shouldn't 
**	be creating a PWD env_var the same goes for OLDPWD. 
**	42 school compputers might behave differently, check!
*/
